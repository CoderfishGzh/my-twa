import {
  require_dist,
  require_dist2
} from "./chunk-F22RKMCC.js";
import "./chunk-PSSONETE.js";
import {
  __commonJS,
  import_buffer,
  import_process,
    ...
    function createProvider(client, address, init) {
      return {
        async getState() {
          ...
          let last = state.lastTransaction ? { lt: BigInt(state.lastTransaction.lt), hash: import_buffer.Buffer.from(state.lastTransaction.hash, "base64") } : null;
          let storage;
  ...
  "node_modules/ton/dist/client/TonClient4.js"(exports) {
    ...
    var TonClient4 = class {
      ...
      async runMethod(seqno, address, name, args) {
        ...
        let resultTuple = runMethod.data.resultRaw ? (0, ton_core_1.parseTuple)(ton_core_1.Cell.fromBoc(import_buffer.Buffer.from(runMethod.data.resultRaw, "base64"))[0]) : [];
        return {
    ...
    function createProvider(client, block, address, init) {
      return {
        async getState() {
          ...
          let last = state.account.last ? { lt: BigInt(state.account.last.lt), hash: import_buffer.Buffer.from(state.account.last.hash, "base64") } : null;
          let storage;
