import {
  require_nacl_fast
} from "./chunk-PSSONETE.js";
import {
  require_react
} from "./chunk-DDBHESBK.js";
import {
  __commonJS,
  __toESM,
  import_buffer,
  ...
  "node_modules/tweetnacl-util/nacl-util.js"(exports, module) {
    ...
    (function(root, f) {
      ...
      if (typeof atob === "undefined") {
        if (typeof import_buffer.Buffer.from !== "undefined") {
          util.encodeBase64 = function(arr) {
            return import_buffer.Buffer.from(arr).toString("base64");
          };
          util.decodeBase64 = function(s2) {
            validateBase64(s2);
            return new Uint8Array(Array.prototype.slice.call(import_buffer.Buffer.from(s2, "base64"), 0));
          };
        } else {
          util.encodeBase64 = function(arr) {
            return new import_buffer.Buffer(arr).toString("base64");
          };
          util.decodeBase64 = function(s2) {
            validateBase64(s2);
            return new Uint8Array(Array.prototype.slice.call(new import_buffer.Buffer(s2, "base64"), 0));
          };
        }
      } else {
        util.encodeBase64 = function(arr) {
...
var TonConnectUIReactError = class extends TonConnectUIError {
  constructor(...args) {
    super(...args);
    Object.setPrototypeOf(this, TonConnectUIReactError.prototype);
  }
};
var TonConnectProviderNotSetError = class extends TonConnectUIReactError {
  constructor(...args) {
    super(...args);
